...
It can return an HTTP code along with a message that states the status of the request. Generally, it can be 200 (OK), 201 (created), 202 (accepted) HTTP status codes along with a text message explaining the particular situation. The message will differ from application to application.

- [ ] How can we partition our application into sub-applications?

Using different files for adding modularity to your application. Creating different files for creating server and using router method for separating routes for different sets of data is a good way to divide an application into sub-applications.
